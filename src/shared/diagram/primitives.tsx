  ...
  return (
    <g>
      <rect
        ...
        rx={6}
        fill={resolveFill(fill).fill}
        fillOpacity={fill === "soft" || fill === "none" ? 1 : fillOpacity}
        stroke={strokeColor}
      />
