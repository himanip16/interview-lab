  ...
  resources: [
    {
      ...
      description: "Learn about the immutable storage format that underlies Cassandra's LSM-tree storage engine.",
    ...
    },
    {
      ...
      description: "How Cassandra distributes data across the cluster ring for automatic load balancing.",
      url: "/deep-dive/consistentHashing",
      slug: "consistentHashing",
      relationship: "buildsOn",
    },
    {
      type: "article",
      title: "PostgreSQL Architecture",
      description: "Compare Cassandra's eventual consistency with PostgreSQL's strong ACID guarantees.",
    ...
    },
    {
      ...
      description: "Explore how DynamoDB uses similar partitioning and consistency models as Cassandra.",
    ...
    },
    {
      ...
      description: "Contrast Cassandra's disk-based storage with Redis's in-memory data structures.",
      url: "/deep-dive/redis",
      slug: "redis",
      relationship: "contrast",
    },
    {
      ...
      description: "Understand the in-memory write buffer that Cassandra uses before flushing to SSTables.",
