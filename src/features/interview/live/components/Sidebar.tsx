...
export default function Sidebar({ summary, phase }: SidebarProps) {
  return (
    <aside className="w-80 border-l border-border bg-muted flex flex-col h-full">
      ...
      <div className="p-6 flex-1 overflow-y-auto">
        ...
        {summary ? (
          ...
          <div className="flex flex-col items-center justify-center h-40 text-center">
            <div className="w-8 h-8 border-2 border-muted border-t-foreground rounded-full animate-spin mb-2" />
